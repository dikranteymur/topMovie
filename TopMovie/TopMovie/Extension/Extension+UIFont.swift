...
extension UIFont {
    ...
    class var fontThin14: UIFont {
        return UIFont(name: FontsName.thin.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 14)
    }
    class var fontLight14: UIFont {
        return UIFont(name: FontsName.light.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 14)
    }
    class var fontRegular14: UIFont {
        return UIFont(name: FontsName.regular.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 14)
    }
    class var fontBold14: UIFont {
        return UIFont(name: FontsName.bold.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 14)
    }
    
    // FontSize: 16
    class var fontThin16: UIFont {
        return UIFont(name: FontsName.thin.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 16)
    }
    class var fontLight16: UIFont {
        return UIFont(name: FontsName.light.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 16)
    }
    class var fontRegular16: UIFont {
        return UIFont(name: FontsName.regular.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 16)
    }
    class var fontBold16: UIFont {
        return UIFont(name: FontsName.bold.rawValue, size: 12) ?? UIFont.systemFont(ofSize: 16)
    }
}
